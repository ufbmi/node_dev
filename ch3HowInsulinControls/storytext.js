...
var storytext_en = {
    ...
    "screen12": "Now let's see how Kara manages her diabetes each day. By knowing when to give herself long acting (basal) insulin, and short acting (bolus) insulin, Kara can control the glucose levels in her body. Here's how she does it!",
    "screen13": "Kara's body needs a little help so that her glucose levels don't get too high. In the morning, Kara takes long acting (basal) insulin to keep her glucose levels in her target range when she's not eating.",
    "screen14": "Now Kara is hungry for breakfast. Before she can eat, she needs to take short acting insulin so her glucose levels won't rise too high from the food.",
    "screen14a": "Now Kara is ready to eat! What a delicious, wholesome breakfast! Because she already took short acting insulin, her glucose levels stay within the target range.",
    "screen15": "When it's lunch time, what should Kara do to manage her blood glucose levels?",
    "screen15a16a": "If Kara chooses to eat food first, her blood glucose level will rise. She can take the insulin afterwards, but it might take a while to make it better. Kara needs to make sure her blood glucose levels don't rise when she eats. She should take the short acting insulin BEFORE eating.",
    "screen15b": "Nice work! If Kara gives herself short acting insulin before eating, her glucose levels won't rise too high when she eats! Now she's ready to eat. Yum!",
    "screen16": "Now it's dinner time! What should Kara do to manage her blood glucose levels?",
    "screen16b": "Nice work! If Kara gives herself short acting insulin, her glucose levels won't rise when she eats! Now she's ready for a fabulous dinner! Delicious!",
    "screen17": "If Kara takes short acting insulin before every meal. She can keep her glucose levels from rising when she eats. The long acting insulin she took in the morning will help keep her glucose levels in the target range all day, and through the night."
};
...
var storytext_es = {
	...
	"screen12": "Ahora, vamos a ver como Kara controla su diabetes. Ella sabe cuando debe tomar su insulina básica de larga duración y su insulina de acción rápida (bolo), y por eso Kara puede controlar el nivel de glucosa en su cuerpo. ¡Ella lo hace así!",
    "screen13": "El cuerpo de Kara necesita ayuda así que su nivel de glucosa de sangre no sube demasiado alto. Por la mañana, Kara toma la insulina básica de larga duración para que su nivel de glucosa permanezca en el rango aceptable cuando ella no come.",
    "screen14": "Ahora, Kara tiene hambre para el desayuno. Ante de que ella pueda comer, Kara necesita tomar la insulina de acción rápida, para que su nivel de glucosa no suba demasiado alto a causa de la comida.",
    "screen14a": "¡Ahora, Kara está lista para comer! ¡Que delicioso y saludable es su desayuno! Kara ya tomo la insulina de acción rápida para que su nivel de glucosa se quede en el rango aceptable.",
    "screen15": "¿Ahora es la hora del almuerzo, que debe hacer Kara para mantener su nivel de glucosa en la sangre?",
    "screen15a16a": "Si Kara decide comer primero, su nivel de glucosa subirá. Ella puede tomar la insulina después de comer pero le tomara tiempo para hacerlo mejor. Kara necesita asegurarse de que su nivel de glucosa no suba cuando ella come. Ella debe tomar la insulina de acción rápida ANTES DE comer.",
    "screen15b": "¡Buen trabajo! ¡Si Kara toma la insulina de acción rápida antes de comer, su nivel de glucosa no sube demasiado alto cuando ella come! Ahora está lista para comer. Yum!",
    "screen16": "¡Ahora es la hora de la cena! ¿Que debe hacer Kara para mantener su nivel de glucosa en la sangre?",
    "screen16b": "¡Buen trabajo! ¡Si Kara toma la insulina de acción rápida antes de comer, su nivel de glucosa no sube demasiado alto cuando ella come! Ahora ella está lista para comer una cena fabulosa. ¡Qué deliciosa!",
    "screen17": "Si Kara toma la insulina de acción rápida antes de cada comida, ella puede mantener su nivel de glucosa sin subir cuando ella come. La insulina básica de larga duración que ella tomó por la mañana controlará su nivel de glucosa para que permanezca en el rango aceptable por todo el día y por toda la noche."
};
...
function read_storytext_call(custom, func) {
    if (exportRoot == undefined) { return; }
    if (exportRoot.getCurrentLabel() == undefined) { return; }
